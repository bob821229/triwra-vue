<template>
  <h1 style="text-align: center;">榮譽董事長</h1>
  <div class="top_wrap">
    <!-- <h2>董事會</h2> -->
    ...
    <!-- <p>
      副院長：<a href="#吳啟瑞">吳啟瑞</a>、<a href="#蘇騰鋐">蘇騰鋐</a>、<a href="#邱雅梅">邱雅梅</a>
    </p> -->
...
import { getChairman } from '../api/api.js'
...
onMounted(async () => {
  const response = await getChairman()
